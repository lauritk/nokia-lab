function [ data_out ] = load_mcsHDF5( filename, streamid, selected )
%convert_mcsHDF5_to_binary
%   Convert MCS HDF5 files to raw binary and remap channels. Converts all the channels. Channels selection not implemented, yet.
%   VERSION: 15.6.2018
%   ----------------------------------------------------------------------
%   DISCLAIMER:
...
%   ----------------------------------------------------------------------
%   TODO:
%   Able to load all the features and channels from all streams.
%   Find correct data stream automagically if stream type is provided.
%   Other features?
