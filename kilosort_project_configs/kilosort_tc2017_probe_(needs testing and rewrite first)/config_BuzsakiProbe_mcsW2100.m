% Kilosort options for TimeCell recordings with MCS W2100 and Buzsaki probe 4x8
% ATLAS Neuroengineering E32B-20-S4-L10-200.
% VERSION: 20.12.2017 by Lauri Kantola, University of Jyväskylä.
% Modified from eMouse sample-project.
...
ops.fbinary             = fullfile(fpath, '403_Random1500_CC6_ITI_60-120s.dat'); % will be created for 'openEphys'		
...
ops.criterionNoiseChannels = 0.2; % fraction of "noise" templates allowed to span all channel groups (see createChannelMapFile for more info) (def 0.2). 		
