...
pathToYourConfigFile = 'C:\MyTemp\openephys_kilosort'; % take from Github folder and put it somewhere else (together with the master_file)

% Load configurations
run(fullfile(pathToYourConfigFile, 'config_tetrode_15.m'))

% Generate chanMap
run(fullfile(pathToYourConfigFile, 'make_tetrode_15.m'))
